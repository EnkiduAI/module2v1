...
public class Order {
	...
	public Order(int orderId, int userId, String userName, String userSurname, int certificateId,
			String certificateName, String certificateDescription, int price, LocalDateTime purchaseDate) {
		super();
