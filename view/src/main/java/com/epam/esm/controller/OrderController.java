...
public class OrderController {
	...
	public ResponseEntity<OrderDto> createOrder(@PathVariable("userId") int userId,
			@PathVariable("certificateId") int certificateId) throws NotFoundException {
		Order order = service.createOrder(userId, certificateId);
	...
	public ResponseEntity<OrderDto> findOrderById(@PathVariable("userId") int userId,
			@PathVariable("orderId") int orderId) throws ServiceException, NotFoundException {
		Order order = service.findUserOrderById(userId, orderId);
