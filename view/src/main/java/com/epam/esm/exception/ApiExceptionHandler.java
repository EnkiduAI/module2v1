...
public class ApiExceptionHandler {
	...
	@ExceptionHandler(value = {ServiceException.class, BadCredentialsException.class})
	public ResponseEntity<ExceptionResponseBody> handleBadRequest(Throwable e) {
	...
	public ResponseEntity<ExceptionResponseBody> handleNotFound(Throwable e) {
		Locale locale = LocaleContextHolder.getLocale();
